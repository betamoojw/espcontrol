...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `generated` | product, firmware, web, docs | Yes | deterministic | — | `node_modules/.bin/esbuild`<br>`esbuild` | `common/**`<br>`devices/**`<br>`builds/**`<br>`components/espcontrol/**`<br>`src/webserver/**`<br>`compatibility/**`<br>`scripts/build.py`<br>`scripts/web_modules.json` | `npm run check:generated` |
...
| `dev-docs` | docs | Yes | deterministic | — | — | `dev-docs/**`<br>`DEVELOPERS.md`<br>`README.md`<br>`product/README.md`<br>`docs/**`<br>`scripts/check_dev_docs.py`<br>`package.json`<br>`.github/workflows/**`<br>`common/config/card_contract.json`<br>`src/webserver/types/**`<br>`components/espcontrol/button_grid*.h` | `npm run check:dev-docs` |
...
| `config` | product, web | Yes | deterministic | — | — | `common/config/**`<br>`src/webserver/**`<br>`compatibility/fixtures/product_compatibility.json`<br>`scripts/check_config_formats.js`<br>`scripts/web_source.js`<br>`scripts/web_modules.json` | `npm run check:config` |
