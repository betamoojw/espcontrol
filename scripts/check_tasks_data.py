...
TASKS = (
    ...
    task("saved-config-parity", ("node", "scripts/check_saved_config_parity.js"), profiles=FAST,
         domains=("firmware", "web"), inputs=("components/espcontrol/button_grid_config_parser.h", "components/espcontrol/button_grid_card_runtime.h", "components/espcontrol/button_grid_contract_generated.h", "components/espcontrol/button_grid_saved_config_options_generated.h", "common/config/card_normalization_fixtures.json", "common/config/*_card_normalization_fixtures.json", "src/webserver/**", "scripts/check_saved_config_parity.js") + WEB_SOURCE_HELPERS + WEB_BUNDLE_INPUTS,
    ...
    task("saved-config-shadow", ("node", "scripts/check_saved_config_shadow.js"), dependencies=("generated",), profiles=FAST,
         domains=("firmware", "web", "product"), inputs=("common/config/card_contract.json", "common/config/vacuum_mower_card_normalization_fixtures.json", "common/config/sensor_card_normalization_fixtures.json", "common/config/confirmation_card_normalization_fixtures.json", "common/config/baseline_card_normalization_fixtures.json", "common/config/media_card_normalization_fixtures.json", "components/espcontrol/button_grid_config_parser.h", "components/espcontrol/button_grid_saved_config_options_generated.h", "components/espcontrol/button_grid_saved_config_shadow_generated.h", "src/webserver/generated/saved_config_shadow.ts", "src/webserver/**", "scripts/check_saved_config_shadow.js") + WEB_SOURCE_HELPERS,
         parallel_safe=True, cache_tools=("c++", "g++", "clang++", "node")),
    task("saved-config-production", ("node", "scripts/check_saved_config_production.js"), dependencies=("generated",), profiles=FAST,
         domains=("firmware", "web", "product"), inputs=("common/config/card_contract.json", "components/espcontrol/button_grid_config_parser.h", "components/espcontrol/button_grid_saved_config_options_generated.h", "src/webserver/application/config_codec.ts", "src/webserver/generated/saved_config_options.ts", "scripts/check_saved_config_production.js"),
         parallel_safe=True, cache_tools=("c++", "g++", "clang++", "node")),
