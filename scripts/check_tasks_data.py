...
TASKS = (
    ...
    task("saved-config-shadow", ("node", "scripts/check_saved_config_shadow.js"), dependencies=("generated",), profiles=FAST,
         domains=("firmware", "web", "product"), inputs=("common/config/card_contract.json", "common/config/vacuum_mower_card_normalization_fixtures.json", "common/config/sensor_card_normalization_fixtures.json", "common/config/baseline_card_normalization_fixtures.json", "components/espcontrol/button_grid_config_parser.h", "components/espcontrol/button_grid_saved_config_shadow_generated.h", "src/webserver/generated/saved_config_shadow.ts", "src/webserver/**", "scripts/check_saved_config_shadow.js") + WEB_SOURCE_HELPERS,
         parallel_safe=True, cache_tools=("c++", "g++", "clang++", "node")),
