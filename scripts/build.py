...
SAVED_CONFIG_OPTIONS_TS = ROOT / "src" / "webserver" / "generated" / "saved_config_options.ts"
SAVED_CONFIG_OPTIONS_H = ROOT / "components" / "espcontrol" / "button_grid_saved_config_options_generated.h"
...
def gen_card_contract_ts(data):
    ...
    return (
        ...
        "// =============================================================================\n"
        "import type { CardConfig, CardOptionSpec, CardTypeSpec, MigrationActionSpec, SavedConfigField } from \"../contracts/types\";\n"
        "\n"
...
def gen_saved_config_options_ts(data):
    rule = data["cards"]["vacuum"]["normalization"]["fields"]["options"]
    if rule.get("policy") != "clear":
        raise BuildError("vacuum production option normalization requires the authored clear policy")
    return (
        "// =============================================================================\n"
...
def gen_saved_config_options_h(data):
    rule = data["cards"]["vacuum"]["normalization"]["fields"]["options"]
    if rule.get("policy") != "clear":
        raise BuildError("vacuum production option normalization requires the authored clear policy")
    return (
...
def sync_card_contract(check_only=False):
    ...
    outputs = [
        ...
        (SAVED_CONFIG_OPTIONS_TS, gen_saved_config_options_ts(data)),
        (SAVED_CONFIG_OPTIONS_H, gen_saved_config_options_h(data)),
