...
Subpages can contain Switch, Action, Trigger, Sensor, Slider, Cover, Climate, Garage Door, Date, Weather, Weather Forecast, and Internal cards. They cannot contain another Subpage card.
