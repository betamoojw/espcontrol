...
[Voice Control](/features/voice-control) is temporarily disabled in current ESP32-P4 86 firmware while the audio stack is replaced. Normal touchscreen, relay, network, and Home Assistant control features continue to work.
